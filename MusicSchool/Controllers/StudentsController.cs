...
namespace MusicSchool.Controllers
{
	public class StudentsController : Controller
	{
		...
		public StudentsController(IStudentService studentService, ICityService cityService, ICountryService countryService)
		{
		...
		public IActionResult Details(int id)
		{
            ...
            ViewBag.Countries = new SelectList(_countryService.GetList(), "Id", "Name", student.StudentContact.Country);
            ViewBag.Cities = new SelectList(_cityService.GetCities(student.StudentContact.CountryId ?? 0), "Id", "Name", student.StudentContact.City);
            return View(student);
		}
		...
		public IActionResult Create(StudentModel student)
		{
			...
			ViewBag.Countries = new SelectList(_countryService.GetList(), "Id", "Name",student.StudentContact.CountryId);
			ViewBag.Cities = new SelectList(_cityService.GetCities(student.StudentContact.CountryId ?? 0), "Id", "Name", student.StudentContact.CityId);
